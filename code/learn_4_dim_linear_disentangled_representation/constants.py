...
Z_DIM = 4
NUMBER_OF_EPOCHS_VAE = 200  # TODO: Find good value (was 35 in original code)
BATCH_SIZE_VAE = 128
...
## Refresh
LOG_PERIOD = 5
VALIDATE_PERIOD = NUMBER_OF_EPOCHS_VAE - 1  # TODO: changed from 1 to NUMBER_OF_EPOCHS_VAE so it saves the last one
SAVING_PERIOD = NUMBER_OF_EPOCHS_VAE - 1  # TODO: changed from 1 to NUMBER_OF_EPOCHS_VAE so it saves the last one
